...
```http
GET /api/topics
# Get all the topics    DONE
```

```http
GET /api/topics/:topic_slug/articles
# Return all the articles for a certain topic DONE
...
# Returns a JSON object with the profile data for the specified user.     DONE
```
